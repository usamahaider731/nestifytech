...
function Index({ data }) {
    const [Brand, SetBrand] = useState(data.data);
    return (
        <div className='w-full px-5 py-7 flex flex-col gap-7.5'>
            <Table values={Brand} className='w-full'>
                <Table.THead className='w-full'>
                    <Table.TR>
                        ...
                        <Table.TH className='w-1/5 font-medium'>Category</Table.TH>
                        <Table.TH className='w-1/5 font-medium'>Parent</Table.TH>
                    ...
                    {Brand && Brand.map((Data) => (
                        <Table.TR className='w-full text-sm bg-permanent h-12 text-res' key={Data.id}>
                            ...
                            <Table.TD className='font-normal text-center text-base'>
                                <div className='w-full flex items-center justify-center'>{Data.image ?
                            ...
                            <Table.TD className='flex'>
                                <div className='w-full flex h-12 my-auto  items-center gap-3 justify-center'>
                                    ...
                                    <Link href={route('brand.edit', { 'id': Data.id })} className='h-6.5 w-6.5 rounded-full bg-primary text-white text-sm flex text-center items-center justify-center'>
