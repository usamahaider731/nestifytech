...
function SecondaryDropdown({ className = '', onChange='', placeholder = 'Select Category', options = [], value = '', valueInTitle = false }) {
    ...
    const setValue = (option) => {
        ...
        setInitialValue(valueInTitle ? (option.title ?? option.name) : option.id);
        setSubOption(null); // Close dropdown
        setOpen(false);
    };
    useEffect(() => {
